...
public class VypisRZP {
    ...
    @XmlElement(name = "REG", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected RegistraceRZP reg;
    @XmlElement(name = "PZI", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected BigInteger pzi;
    @XmlElement(name = "ZI", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
