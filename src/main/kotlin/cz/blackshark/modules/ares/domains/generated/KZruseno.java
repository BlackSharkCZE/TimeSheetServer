...
public class KZruseno {
    ...
    @XmlElement(name = "O_podnetu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected int oPodnetu;
    @XmlElement(name = "O_podn_zrus", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected int oPodnZrus;
    @XmlElement(name = "O_upadce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
