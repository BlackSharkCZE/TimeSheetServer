...
public class SpravceKonkurzuCEU {
    ...
    @XmlElement(name = "Cele_jmeno_spravce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", required = true)
    protected String celeJmenoSpravce;
    @XmlElement(name = "A_spravce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected AdresaARES aSpravce;
    @XmlElement(name = "B_spravce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
