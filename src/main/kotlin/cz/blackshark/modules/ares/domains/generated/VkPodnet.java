...
public class VkPodnet {
    ...
    @XmlElement(name = "S_podnetu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected int sPodnetu;
    @XmlElement(name = "Cislo_vety_ceu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected int cisloVetyCeu;
    @XmlElement(name = "Stornuj", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected Integer stornuj;
    @XmlElement(name = "DV", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar dv;
    @XmlElement(name = "Cislo_soudu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected short cisloSoudu;
    @XmlElement(name = "K_ukonu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected short kUkonu;
    @XmlElement(name = "Cislo_senatu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected Short cisloSenatu;
    @XmlElement(name = "Cislo_znacky", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected short cisloZnacky;
    @XmlElement(name = "Rok_znacky", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected short rokZnacky;
    @XmlElement(name = "KKZ_vyrovnani", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", required = true)
    ...
    @XmlSchemaType(name = "string")
    protected Pfc pfo;
    @XmlElement(name = "Cele_jmeno", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    ...
    protected String rc;
    @XmlElement(name = "URL_detail", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", required = true)
    protected String urlDetail;
    @XmlElement(name = "URL_usneseni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected String urlUsneseni;
    @XmlElement(name = "Spravce_konkurzni_podstaty", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected String spravceKonkurzniPodstaty;
    @XmlElement(name = "S_vety", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", required = true)
    @XmlSchemaType(name = "string")
