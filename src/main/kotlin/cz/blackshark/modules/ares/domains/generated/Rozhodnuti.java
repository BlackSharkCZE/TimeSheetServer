...
public class Rozhodnuti {
    ...
    @XmlElement(name = "Typ_rozhodnuti", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected String typRozhodnuti;
    @XmlElement(name = "Cislo_rozhodnuti", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected String cisloRozhodnuti;
    @XmlElement(name = "Datum_rozhodnuti", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar datumRozhodnuti;
    @XmlElement(name = "Pravni_moc", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    @XmlSchemaType(name = "date")
