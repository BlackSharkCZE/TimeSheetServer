...
public class VysledekDotazu {
    ...
    @XmlElement(name = "Pocet_nalezenych", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    ...
    @XmlElement(name = "Pocet_nenalezenych", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected Integer pocetNenalezenych;
    @XmlElement(name = "Seznam_nenalezenych", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected Slovo seznamNenalezenych;
    @XmlElement(name = "Pocet_navracenych", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected Integer pocetNavracenych;
    @XmlElement(name = "Seznam_navracenych", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
