...
public class AdresaUIR {
    ...
    @XmlElement(name = "KOL", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.3")
    protected String kol;
    @XmlElement(name = "KK", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.3")
    protected String kk;
    @XmlElement(name = "KOK", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.3")
    @XmlSchemaType(name = "integer")
    protected Integer kok;
    @XmlElement(name = "KO", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.3")
    protected String ko;
    @XmlElement(name = "KPO", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.3")
    protected String kpo;
    @XmlElement(name = "KSO", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.3")
    protected String kso;
    @XmlElement(name = "KN", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.3")
    protected String kn;
    @XmlElement(name = "KCO", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.3")
    protected String kco;
    @XmlElement(name = "KMC", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.3")
    protected String kmc;
    @XmlElement(name = "PSC", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.3")
    protected String psc;
    @XmlElement(name = "KUL", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.3")
    protected String kul;
    @XmlElement(name = "CD", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.3")
    protected Integer cd;
    @XmlElement(name = "TCD", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.3")
    protected Byte tcd;
    @XmlElement(name = "CO", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.3")
    protected String co;
    @XmlElement(name = "PCO", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.3")
    protected String pco;
    @XmlElement(name = "KA", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.3")
    protected String ka;
    @XmlElement(name = "KOB", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.3")
    protected String kob;
    @XmlElement(name = "PCD", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/uvis_datatypes/v_1.0.3")
