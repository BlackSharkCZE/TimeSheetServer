...
public class Uvod {
    ...
    @XmlElement(name = "ND", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected String nd;
    @XmlElement(name = "ADB", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar adb;
    @XmlElement(name = "DVY", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar dvy;
    @XmlElement(name = "CAS", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    @XmlSchemaType(name = "time")
    protected XMLGregorianCalendar cas;
    @XmlElement(name = "TV", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected String tv;
    @XmlElement(name = "PDP", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar pdp;
    @XmlElement(name = "Typ_odkazu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected String typOdkazu;
    @XmlElement(name = "Typ_odpovedi", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
