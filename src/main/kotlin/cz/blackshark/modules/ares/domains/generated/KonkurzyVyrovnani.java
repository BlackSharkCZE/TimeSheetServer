...
public class KonkurzyVyrovnani {
    ...
    @XmlElement(name = "Ukon", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", required = true)
    protected List<Ukon> ukon;
     ...
     *
     */
    public List<Ukon> getUkon() {
        if (ukon == null) {
            ukon = new ArrayList<Ukon>();
        }
        return this.ukon;
    }
