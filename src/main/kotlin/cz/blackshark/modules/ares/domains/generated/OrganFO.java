...
public class OrganFO {
    ...
    @XmlElement(name = "Nazev_organu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected String nazevOrganu;
    @XmlElement(name = "Poznamka", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    ...
    protected String p;
    @XmlElement(name = "Rodne_prijmeni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
