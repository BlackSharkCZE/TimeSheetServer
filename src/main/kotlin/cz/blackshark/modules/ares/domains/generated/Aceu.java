...
public class Aceu {
    ...
    @XmlElement(name = "K_konkurz", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", required = true)
    protected KKonkurz kKonkurz;
    @XmlElement(name = "Poradi", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected short poradi;
    @XmlElement(name = "DV_podnetu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar dvPodnetu;
    @XmlElement(name = "K_ukonu_podnetu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected byte kUkonuPodnetu;
    @XmlElement(name = "Priznak_usneseni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", required = true)
    protected String priznakUsneseni;
    @XmlElement(name = "Radky_textu_usneseni", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected RadkyTextuUsneseni radkyTextuUsneseni;
    @XmlElement(name = "J_souboru_s_usnesenim", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected String jSouboruSUsnesenim;
    @XmlElement(name = "Spravce_konkurzu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected List<SpravceKonkurzuCEU> spravceKonkurzu;
    @XmlElement(name = "Priznaky", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", required = true)
