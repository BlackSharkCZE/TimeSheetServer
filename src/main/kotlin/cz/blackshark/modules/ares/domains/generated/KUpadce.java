...
public class KUpadce {
    ...
    @XmlElement(name = "S_upadce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    protected int sUpadce;
    @XmlElement(name = "PFC", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", required = true)
    @XmlSchemaType(name = "string")
    protected Pfc pfc;
    @XmlElement(name = "K_eksubj", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
    ...
    @XmlElement(name = "SKO", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", required = true)
    @XmlSchemaType(name = "string")
    protected StavUpadceCEU sko;
    @XmlElement(name = "SVY", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", required = true)
    @XmlSchemaType(name = "string")
