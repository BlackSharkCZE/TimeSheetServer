...
object Hql {
	...
	const val COUNT_BY_USED_TIME = "fromTime < :time AND toTime > :time and subject.id = :subject"
	const val COUNT_BY_USED_TIME_WITH_ID_EXCEPTION = "fromTime < :time AND toTime > :time AND id != :id and subject.id = :subject"
