...
public class VkAdresa {
    ...
    @XmlElement(name = "Upadce_spravce", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", required = true)
    @XmlSchemaType(name = "string")
    protected UpadceSpravceCEU upadceSpravce;
    @XmlElement(name = "K_typu_adresy", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3")
